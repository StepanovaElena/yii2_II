            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <h3 class="profile-username text-center"><?=$profile->getUsername() ?></h3>

                        <p class="text-muted text-center">Software Engineer</p>

                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>Active projects</b> <a class="pull-right">1,322</a>
                            </li>
                            <li class="list-group-item">
                                <b>Tasks</b> <a class="pull-right">543</a>
                            </li>
                            <li class="list-group-item">
                                <b>Total projects</b> <a class="pull-right">13,287</a>
                            </li>
                            <li class="list-group-item">
                        ...
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="sparkbar" data-color="#00a65a" data-height="20">16</div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="sparkbar" data-color="#f39c12" data-height="20">3</div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="sparkbar" data-color="#00c0ef" data-height="20">1</div>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
