...
class ProfileEditForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['uuid'], 'required', 'when' => function(){
                return !$this->scenario !== self::SCENARIO_UPDATE_USER;
            }],
        ];
    }

    public function scenarioUuid(): self
    {
        $this->setScenario(self::SCENARIO_UPDATE_USER);
        return $this;
    }
    ...
    {
        return array_merge([
            self::SCENARIO_UPDATE_USER => ['uuid']
        ], parent::scenarios());
    }
}